...
CREATE TABLE derp_books.general_ledgers (
  ...
  CONSTRAINT fk_general_ledgers_stack_name FOREIGN KEY (stack_name) REFERENCES derp_books.stacks (stack_name) ON DELETE CASCADE,
  CONSTRAINT pk_general_ledgers PRIMARY KEY (general_ledger_name, stack_name)
);
COMMIT;
